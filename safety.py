    ...
    if triggered_critical:
        return SafetyWarning(
            ...
            message=(
                ...
                "**Рекомендация:**\n"
                "- При острой боли, одышке, потере сознания — вызовите скорую помощь (103 или 112)\n"
                "- При менее острых симптомах — обратитесь к терапевту в ближайшее время"
            ),
...
def format_safety_footer(card: KnowledgeCard) -> str:
    """Формирует текст с предупреждениями для карточки"""
    warnings = []
