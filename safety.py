...
CRITICAL_SYMPTOMS = [
    ...
    "онемение руки", "боль отдает в челюсть", "боли в груди", "давящей боли",

    # Неврологические
    "потеря сознания", "судороги", "паралич", "нарушение речи",
    "внезапная головная боль", "двоение в глазах", "потерял сознание",
    "паралича",
    ...
    "рвет с кровью", "сильно болит живот"

    # Психическое здоровье
    "суицид", "хочу умереть", "паническая атака", "не могу дышать от страха",
    "слышу голоса", "теряю связь с реальностью", "панической атакой", "ничего не слышу", "заложило уши"
...
CAUTION_KEYWORDS = [
    ...
    "похуд", "диет", "голод", "детокс", "очищени", "беременной"
]

PERSONALIZATION_CONTEXTS = [
    "сколько мне", "мне нужно", "я хочу", "как мне",
    "подходит ли", "можно ли мне", "безопасно ли", "как сделать так что"
]
